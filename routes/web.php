...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
	...
	#city
	Route::post('addCity', 'AdminController@storeCity')->name('addCity');
	...
	Route::get('offers/add', 'OffersController@addOffers');
	Route::get('offers/edit/{id}', 'OffersController@editOffers');
	Route::post('offers/', 'OffersController@addEditOffers');
	...
	Route::get('pages/addpage', 'PagesController@addeditPage');
	Route::get('pages/addpage/{id}', 'PagesController@editPage');
	Route::post('pages/addpage', 'PagesController@addnew');
	Route::get('pages/delete/{id}', 'PagesController@delete');
	Route::get('blog', 'BlogController@pages');
	Route::get('blog/addpage', 'BlogController@addeditPage');
	Route::get('blog/addpage/{id}', 'BlogController@editPage');
	Route::post('blog/addpage', 'BlogController@addnew');
	...
	Route::get('promocodes', 'PromoController@promoCodes');
	Route::get('promocodes/add', 'PromoController@addeditpromocode');
	Route::get('restaurants/edit/{id}', 'PromoController@editpromocode');
	...
	Route::get('restaurants/view/{id}/image', 'ImageController@imagelist');
	Route::get('restaurants/view/{id}/image/addimage', 'ImageController@addeditmenu');
	Route::get('restaurants/view/{id}/image/addimage/{image_id}', 'ImageController@editmenu');
	Route::post('restaurants/view/{id}/image/addimage', 'ImageController@addnew');
	Route::get('restaurants/view/{id}/image/delete/{image_id}', 'ImageController@delete');
	...
	Route::get('merchants', 'UsersController@merchants');
	Route::get('merchant/adduser/{id}', 'UsersController@editMerchant');
	Route::post('merchant/adduser', 'UsersController@addMerchant');
	...
	Route::post('users/address', 'UsersController@saveAddresses');
	Route::post('users/singleAddress', 'UsersController@saveSingleAddresses');
	Route::get('users/adduser/{id}', 'UsersController@editUser');
	Route::get('users/address/{id}', 'UsersController@editAddress');
	Route::get('users/editaddress/{id}', 'UsersController@editSingleAddress');
	...
	Route::get('temp','IndexController@temp');
...
Route::get('password/reset/{token}/{usertype}', 'Auth\PasswordController@getReset');
Route::post('contact_send', 'IndexController@contact_send');
Route::post('subscribe', 'IndexController@subscribe');
Route::get('/reset-success', 'IndexController@resetSuccess');
Route::get('/user/verify/{token}', 'Auth\RegisterController@verifyUser');
Route::get('/{slug}', 'Admin\PagesController@show');
