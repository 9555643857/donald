...
//$isValidChecksum = verifychecksum_e($paramList, DONALD00058424809411, $paytmChecksum); //will return TRUE or FALSE string.

$isValidChecksum = verifychecksum_e($paramList, Donald10808253656312, $paytmChecksum); //will return TRUE or FALSE string.
