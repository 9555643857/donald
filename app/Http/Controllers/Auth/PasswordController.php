...
class PasswordController extends Controller
{
    ...
    */
	...
	public function merchantEmail(Request $request)
   {
   ...
   /**
     ...
     */
    public function getReset($token = null,$usertype='user')
    {
        if (is_null($token)) {
      ...
      // dd($request);
	   ...
	   $this->validate($request, [
        ...
        $credentials = $request->only(
            'email', 'password','usertype', 'password_confirmation', 'token'
        );
...
//dd( $credentials['usertype']=ucfirst($credentials['usertype']));
