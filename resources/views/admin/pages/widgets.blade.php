...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#footer_widgets" aria-controls="footer_widgets" role="tab" data-toggle="tab">Extra Info</a>
        </li>
        ...
        <div role="tabpanel" class="tab-pane active" id="footer_widgets">             
            {!! Form::open(array('url' => 'admin/footer_widgets','class'=>'form-horizontal padding-15','name'=>'about_contact_widgets_form','id'=>'about_contact_widgets_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="footer_widget1_desc" class="summernote" rows="3" placeholder="A few words about site">{{ $widgets->footer_widget1_desc }}</textarea>
                    </div>
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea type="text" name="footer_widget2_desc" class="summernote" rows="3" placeholder="A few words about site">{{ $widgets->footer_widget2_desc }}</textarea>
                    </div>
                </div>
                <hr>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Widget 3 Description</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="footer_widget3_address" class="summernote" rows="3" placeholder="A few words about site">{{ $widgets->footer_widget3_address }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Contact Emails</label>
                    <div class="col-sm-9">
