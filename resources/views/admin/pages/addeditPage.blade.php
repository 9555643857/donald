...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($page->title) ? 'Edit: '. $page->title : 'Add Page' }}</h2>
		
		<a href="{{ URL::to('admin/pages') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> Back</a>
	...
	@endif
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                {!! Form::open(array('url' => array('admin/pages/addpage'),'class'=>'form-horizontal padding-15','name'=>'page_form','id'=>'page_form','role'=>'form','enctype' => 'multipart/form-data')) !!} 
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Page URL</label>
                    <div class="col-sm-9">
