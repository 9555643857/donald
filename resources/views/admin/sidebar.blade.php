	...
	<div class="nicescroll">
		<div class="wrapper" style="margin-bottom:90px">
			<ul class="nav nav-sidebar" id="sidebar-menu">
					...
					<li class="{{classActivePath('offers')}}"><a href="{{ URL::to('admin/offers') }}"><i class="fa fa-gift"></i>Offers</a></li>
	                
	                <li class="{{classActivePath('users')}}"><a href="{{ URL::to('admin/users') }}"><i class="fa fa-users"></i>Users</a></li>
					<li class="{{classActivePath('pages')}}"><a href="{{ URL::to('admin/pages') }}"><i class="fa fa-file"></i>Pages</a></li>
					<li class="{{classActivePath('blog')}}"><a href="{{ URL::to('admin/blog') }}"><i class="fa fa-file"></i>Blog</a></li>
					<li class="{{classActivePath('promocodes')}}"><a href="{{ URL::to('admin/promocodes') }}"><i class="fa  fa-tag"></i>Promo codes</a></li>
